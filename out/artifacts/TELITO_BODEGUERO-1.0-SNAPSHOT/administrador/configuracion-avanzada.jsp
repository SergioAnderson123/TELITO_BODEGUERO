...
<head>
    ...
    <style>
        ...
        .config-label { font-weight: 600; color: #00a896; margin-bottom: 0.5rem; }
        ...
        .nav-tabs .nav-link.active {
            ...
            font-weight: 700;
            box-shadow: 0 -3px 8px rgba(0,168,150,.15);
        }
        ...
        /* Mejorar card headers */
        .card-header.bg-primary {
            background: linear-gradient(135deg, #00a896 0%, #83c5be 100%) !important;
            border: none;
        }
        
        .card-header.bg-info {
            background: linear-gradient(135deg, #028f80 0%, #00a896 100%) !important;
            border: none;
        }
        
        .card-header.bg-secondary {
            background: linear-gradient(135deg, #6c757d 0%, #83c5be 100%) !important;
            border: none;
        }
        
        .card-header.bg-danger {
            background: linear-gradient(135deg, #dc3545 0%, #ff6b7a 100%) !important;
            border: none;
        }
