...
<%
    ...
    String proveedorId = (String) request.getAttribute("proveedor");
    String estado = (String) request.getAttribute("estado");
    if (busqueda == null) busqueda = request.getParameter("busqueda");
    if (proveedorId == null) proveedorId = request.getParameter("proveedor");
    ...
    <div class="dashboard-wrapper">
        <div class="dashboard-content">
            ...
            <div class="page-header mb-4">
                <h2 class="pageheader-title"><i class="fas fa-envelope me-2"></i>Enviar Reporte de Órdenes de Compra por Correo</h2>
                <p class="pageheader-text">Genera y envía un reporte Excel de Órdenes de Compra por correo electrónico.</p>
            </div>
                        ...
                        <div class="card-body">
                            <div class="alert alert-info mb-4">
                                ...
                                <ul class="mb-0 mt-2">
                                    ...
                                    <li><strong>Total General</strong> de todas las órdenes</li>
                                </ul>
                                <p class="mb-0 mt-2"><strong>Filtros aplicados:</strong> <%= filtrosInfo.toString() %></p>
                            </div>

                            <form action="<%= request.getContextPath() %>/logistica/OrdenCompraReporteServlet" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="asunto" name="asunto" 
                                           value="Reporte de Órdenes de Compra - TELITO BODEGUERO" 
                                ...
                                <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                                    <a href="<%= request.getContextPath() %>/orden-compra<%
                                        if (busqueda != null || proveedorId != null || estado != null) {
                                            out.print("?");
                                            boolean first = true;
                                            if (busqueda != null) {
                                            ...
                                            if (proveedorId != null) {
                                                if (!first) out.print("&");
                                                out.print("proveedor=" + java.net.URLEncoder.encode(proveedorId, "UTF-8"));
                                                first = false;
                                            }
                                            if (estado != null) {
                                                if (!first) out.print("&");
