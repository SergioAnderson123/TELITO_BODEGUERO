...
<head>
    ...
    <style>
        ...
        /* Ocultar el selector de cantidad de registros y los botones anterior/siguiente */
        .dataTables_length,
        ...
        jQuery(document).ready(function($) {
            ...
            var tableConfig = {
                ...
                drawCallback: function() {
                    // Ocultar botones anterior y siguiente
                    var api = this.api();
                    $(api.table().container()).find('.dataTables_paginate .paginate_button.previous').hide();
                    $(api.table().container()).find('.dataTables_paginate .paginate_button.next').hide();
                }
            };
