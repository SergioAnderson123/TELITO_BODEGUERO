<%@ page import="com.example.telito.administrador.daos.AlertaDAO" %>
...
<%
    ...
    int totalAlertas = alertaDAO.contarAlertas();
    ...
    <div class="dashboard-wrapper">
        <div class="dashboard-content">
            ...
            <div class="page-header mb-4">
                <h2 class="pageheader-title">Enviar Reporte de Alertas por Correo</h2>
                <p class="pageheader-text">Genera y envía un reporte Excel de alertas configuradas por correo electrónico.</p>
            </div>
                    ...
                    <div class="table-card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info mb-4">
                                ...
                                <strong>Información del reporte:</strong> Se generará un reporte con todas las alertas configuradas en el sistema.
                            </div>

                            <div class="alert alert-info mb-4">
                                <i class="fas fa-list me-2"></i>
                                <strong>Total de alertas:</strong> <%= totalAlertas %>
                            </div>

                            <form action="<%= request.getContextPath() %>/AlertaReporteServlet" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="asunto" name="asunto" 
                                           value="Reporte de Alertas - TELITO BODEGUERO" 
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <strong>Nota:</strong> El archivo Excel se generará con todas las alertas configuradas en el sistema. 
                                    Incluirá todas las columnas (ID, Nombre, Tipo, Condición, Categoría, Rol a Notificar, Estado) y tendrá filtros automáticos habilitados.
                                </div>

                                <div class="d-flex justify-content-between">
                                    <a href="<%= request.getContextPath() %>/AlertaServlet?action=listar" class="btn btn-secondary">
