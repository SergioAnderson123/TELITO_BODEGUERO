...
<style>
    ...
    .dashboard-main-wrapper { display:flex; min-height:100vh; overflow-x: hidden !important; max-width: 100vw !important; }
    ...
    .dashboard-wrapper { margin-left:250px; width:calc(100% - 250px); min-height:100vh; overflow-x: hidden !important; max-width: calc(100vw - 250px) !important; }
    .dashboard-content { margin-top:70px; padding:30px; padding-bottom: 100px; overflow-x: hidden !important; max-width: 100% !important; }
