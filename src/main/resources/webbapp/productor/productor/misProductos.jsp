...
<%@ page import="com.example.telitobodeguero.beans.Categoria" %>
            ...
            <tr data-category="<%= p.getCategoria().getNombre() %>" data-price="<%= String.format(java.util.Locale.US, "%.2f", p.getPrecioActual()) %>" data-sku="<%= p.getCodigoSKU() %>" data-name="<%= p.getNombre() %>">
                ...
                <td>
                    <%
                        ...
                        com.example.telitobodeguero.daos.ProductoDao productoDao = new com.example.telitobodeguero.daos.ProductoDao();
