...
<body>
  ...
  <main class="content" id="content">
    ...
    <div class="row mt-4">
      ...
      <div class="col-lg-3 col-md-6 mb-4"><a href="<%= request.getContextPath() %>/acceso-roles.jsp" class="card quick-link-card"><i class="fas fa-user-shield"></i><h5>Roles y permisos</h5><span>Asignación y políticas</span></a></div>
      <div class="col-lg-3 col-md-6 mb-4"><a href="<%= request.getContextPath() %>/configuracion.jsp" class="card quick-link-card"><i class="fas fa-cogs"></i><h5>Configuración</h5><span>Sistema y plantillas</span></a></div>
