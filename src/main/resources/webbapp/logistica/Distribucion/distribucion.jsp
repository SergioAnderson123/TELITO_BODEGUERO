...
<%@ page import="org.example.webbapplogistica.model.beans.PlanTransporteBean" %>
<%@ page import="org.example.webbapplogistica.model.beans.ConductorBean" %>
<!doctype html>
<html lang="es">
<head>
    <%-- ... (La sección <head> no cambia) ... --%>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Distribución y Transporte - Sistema de Logística</title>
    <meta name="description" content="Sistema de gestión logística - Distribución y Transporte">
        ...
        <div class="menu-list">
            <nav class="navbar navbar-expand navbar-light">
                <ul class="navbar-nav flex-column w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/planes-transporte">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-header">
                        <h1 class="pageheader-title">Planes de Transporte</h1>
                    </div>
                </div>
            </div>
...
<%-- El script de paginación y los estilos no cambian --%>
