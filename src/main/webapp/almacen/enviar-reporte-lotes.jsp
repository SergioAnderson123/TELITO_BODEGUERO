    ...
    <div class="dashboard-wrapper">
        <div class="dashboard-content">
            ...
            <div class="page-header mb-4">
                ...
                <p class="text-muted">Genera y envía un reporte Excel de los lotes del almacén por correo electrónico.</p>
            </div>
                        ...
                        <div class="card-body">
                            <div class="alert alert-info mb-4">
                                ...
                                <ul class="mb-0 mt-2">
                                    ...
                                    <li>Estado Stock</li>
                                    <li>Estado</li>
                                    <li><strong>Stock Total y Paquetes Totales</strong></li>
                                </ul>
                            </div>

                            <form action="<%= request.getContextPath() %>/almacen/LoteReporteServlet" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="asunto" name="asunto" 
                                           value="Reporte de Lotes - Almacén - TELITO BODEGUERO">
                                </div>
