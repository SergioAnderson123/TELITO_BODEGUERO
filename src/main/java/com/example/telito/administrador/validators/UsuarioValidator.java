...
/**
 * Clase para validar datos de usuario antes de crear o actualizar.
...
public class UsuarioValidator {
     ...
     * @param usuarioDAO DAO para verificar duplicados
     * @param verificarEmailDuplicado Si debe verificar que el email no esté registrado
